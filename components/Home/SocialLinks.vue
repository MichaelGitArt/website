...
const links = [
  {
    name: "GitHub",
    url: "https://github.com/MichaelGitArt",
    icon: "mdi:github",
  },
  {
    name: "Bluesky",
    url: "https://bsky.app/profile/michaelgitart.bsky.social",
    icon: "mdi:butterfly-outline",
  },
  {
    name: "Linkedin",
    url: "https://www.linkedin.com/in/michaelgitart/",
    icon: "mdi:linkedin",
  },
  {
    name: "X",
    url: "https://x.com/MichaelGitart",
    icon: "X",
  },
  {
    name: "Instagram",
    url: "https://www.instagram.com/michaelgitart/",
    icon: "mdi:instagram",
  }
];
</script>
